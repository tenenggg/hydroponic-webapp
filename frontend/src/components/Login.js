...
// captures user email and password
function Login() {
  ...
  const handleLogin = async (e) => {  
    ...
    try {
      const { data, error } = await supabase.auth.signInWithPassword({ // Authenticate user with email and password
        email,
        password,
      });
      ...
      // This allows the frontend to know the user's role for access control
